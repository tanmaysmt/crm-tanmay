...
export class FeedbackDetailsComponent {
  ...
  imageSrc = this.srcUrl+'/avatar/avatar.png';
  displayedColumns: string[] = ['id','phone','call_action','feedback_status' ,'business_card','message' ,'created_at'];
  ...
  getleadsList(){
    ...
    .subscribe(result  => {
      if(result){
        ...
        this.leads = result.data[0].lead;
        this.count = result.total_rows;
  ...
  openBusinessCard(data:any){
    console.log(data);
    this.businessCard = data
    $("#modal-businessCard").modal("show");
  }
  openMessage(data:any){
    console.log(data);
    this.feedbackMessage = data;
    $("#modal-feedbackMessage").modal("show");
  }
}
